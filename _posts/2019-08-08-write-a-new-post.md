...
> If you are building the site via `chirpy-starter`, copy that file from the gem installation directory (check with command `bundle info --path jekyll-decode-doubt`) to the same directory in your repository.
{: .prompt-tip }
