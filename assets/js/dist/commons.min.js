...
!(function () {
  ...
  function T(t, e, n, i) {
    ...
    for (const [r, s] of Object.entries(o))
      r.includes(i) && L(t, e, n, s.callable, s.delegationSelector);
  }
  function j(t) {
    return ((t = t.replace(m, '')), _[t] || t);
  }
  const S = {
    on(t, e, n, i) {
      C(t, e, n, i, !1);
    ...
    off(t, e, n, i) {
      ...
      if (void 0 === r) {
        ...
        for (const [n, i] of Object.entries(l)) {
          const o = n.replace(v, '');
          (a && !e.includes(o)) || L(t, c, s, i.callable, i.delegationSelector);
        }
      } else {
  ...
  var it = 'top',
    ...
    pt = 'popper',
    ht = 'reference',
    gt = ct.reduce(function (t, e) {
      return t.concat([e + '-' + lt, e + '-' + ut]);
    }, []),
    mt = [].concat(ct, [at]).reduce(function (t, e) {
  ...
  function Ht(t, e, n) {
    ...
    var s = (jt(t) ? Tt(t) : window).visualViewport,
      a = !Ft() && n,
  ...
  function Kt(t) {
    for (var e = Tt(t), n = Ut(t); n && qt(n) && 'static' === Rt(n).position; )
      n = Ut(n);
    return n &&
      ('html' === Lt(n) || ('body' === Lt(n) && 'static' === Rt(n).position))
      ? e
      : n ||
          (function (t) {
            var e = /firefox/i.test(It());
            if (/Trident/i.test(It()) && St(t) && 'fixed' === Rt(t).position)
              return null;
            var n = Yt(t);
            for (
              kt(n) && (n = n.host);
              St(n) && ['html', 'body'].indexOf(Lt(n)) < 0;
            ) {
              var i = Rt(n);
              if (
                'none' !== i.transform ||
  ...
  function be(t, e) {
    ...
    var n = e,
      ...
      g = n.padding,
      m = void 0 === g ? 0 : g,
      v = $t('number' != typeof m ? m : Gt(m, ct)),
      b = d === pt ? ht : pt,
      y = t.rects.popper,
      _ = t.elements[h ? b : d],
      w = me(jt(_) ? _ : _.contextElement || Vt(t.elements.popper), c, u, s),
  ...
  var Ce = {
    ...
    fn: function (t) {
      var e = t.state,
        ...
        h = n.tetherOffset,
        g = void 0 === h ? 0 : h,
        m = be(e, { boundary: c, rootBoundary: l, padding: f, altBoundary: u }),
        v = Dt(e.placement),
        b = Zt(e.placement),
        y = !b,
        _ = Qt(v),
      ...
      if (E) {
        if (r) {
          var j,
            ...
            $ = D + U - X,
            G = Xt(p ? Nt(M, D + Y - X - Q) : M, D, p ? Mt(N, $) : N);
          ((E[_] = G), (T[_] = G - D));
        }
        if (a) {
          var J,
        ...
        u = {
          ...
          forceUpdate: function () {
            if (!l) {
              ...
              if (Se(e, n)) {
                ((a.rects = {
                  reference: Le(e, Kt(n), 'fixed' === a.options.strategy),
                  popper: zt(n),
                }),
                  (a.reset = !1),
  ...
  var Pe = ke(),
    De = ke({ defaultModifiers: [oe, Ae, ne, Pt] }),
    Me = ke({ defaultModifiers: [oe, Ae, ne, Pt, xe, _e, Ce, Jt, Oe] }),
    Ne = Object.freeze({
      __proto__: null,
      afterMain: Et,
      afterRead: yt,
  ...
  var on;
  d(nn);
  const rn = document.getElementById('toc-bar'),
    sn = document.getElementById('toc-solo-trigger'),
  ...
  class dn {
    static initBar() {
      (new IntersectionObserver(
        (t) => {
          t.forEach((t) => {
            rn.classList.toggle('invisible', t.isIntersecting);
          });
        },
        { rootMargin: '-'.concat(P(dn, this, hn)._, 'px 0px 0px 0px') },
      ).observe(sn),
        (pn._ = P(dn, this, !1)));
    }
    ...
    static refresh() {
      (P(dn, this, pn)._ && this.initComponents(),
    ...
    static hidePopup() {
      (cn.toggleAttribute(fn),
        cn.addEventListener(
          'animationend',
          () => {
            (cn.toggleAttribute(fn), cn.close());
          },
          { once: !0 },
        ),
        this.lockScroll(!1));
    ...
    static lockScroll(t) {
      (document.documentElement.classList.toggle(un, t),
        document.body.classList.toggle(un, t));
    }
    static clickBackdrop(t) {
      if (cn.hasAttribute(fn)) return;
  ...
  D(dn, 'options', {
    ...
    scrollSmooth: !1,
    collapseDepth: 4,
    headingsOffset: P((on = dn), on, hn)._,
  });
  (D(
    class {
      static refresh() {
  ...
  const mn = document.getElementById('sidebar'),
    vn = document.getElementById('sidebar-trigger'),
    bn = document.getElementById('mask');
  class yn {
    static toggle() {
      ((_n._ = P(yn, this, !P(yn, this, _n)._)),
        document.body.toggleAttribute('sidebar-display', P(yn, this, _n)._),
        mn.classList.toggle('z-2', P(yn, this, _n)._),
        bn.classList.toggle('d-none', !P(yn, this, _n)._));
    }
  }
  var _n = { _: !1 };
  const wn = document.getElementById('sidebar-trigger'),
    En = document.getElementById('search-trigger'),
    On = document.getElementById('search-cancel'),
    xn = document.querySelectorAll('#main-wrapper>.container>.row'),
    An = document.getElementById('topbar-title'),
    Cn = document.getElementById('search'),
  ...
  class Bn {
    ...
    static off() {
      this.resultVisible &&
        ((Tn.innerHTML = ''),
        Sn.classList.contains(Pn) && Sn.classList.remove(Pn),
        Ln.classList.add(Pn),
        xn.forEach((t) => {
  ...
  function In() {
    return On.classList.contains(kn);
  }
  (D(Bn, 'resultVisible', !1),
    (vn.onclick = bn.onclick = () => yn.toggle()),
    En.addEventListener('click', () => {
      (Nn.on(), Bn.on(), jn.focus());
    }),
    ...
    jn.addEventListener('input', () => {
      '' === jn.value
        ? In()
          ? Sn.classList.remove(Pn)
          : Bn.off()
        : (Bn.on(), In() && Sn.classList.add(Pn));
    }),
    gn &&
