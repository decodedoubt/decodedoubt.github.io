...
!(function () {
  ...
  const W = (t) => {
    ...
    U = 'hide'.concat(q),
    K = 'hidden'.concat(q),
    Q = 'click'.concat(q).concat('.data-api'),
    X = 'show',
    $ = 'collapse',
    G = 'collapsing',
  ...
  class nt extends z {
    constructor(t, e) {
      ...
      for (const t of n) {
        const e = R.getSelectorFromElement(t),
          n = R.find(e).filter((t) => t === this._element);
    ...
    _getFirstLevelChildren(t) {
      const e = R.find(J, this._config.parent);
  ...
  function Ut(t) {
    return St(t) && 'fixed' !== Rt(t).position ? t.offsetParent : null;
  }
  function Kt(t) {
    for (var e = Lt(t), n = Ut(t); n && qt(n) && 'static' === Rt(n).position; )
      n = Ut(n);
    return n &&
      ('html' === Tt(n) || ('body' === Tt(n) && 'static' === Rt(n).position))
      ? e
      : n ||
          (function (t) {
            var e = /firefox/i.test(Ft());
            if (/Trident/i.test(Ft()) && St(t) && 'fixed' === Rt(t).position)
              return null;
            var n = Yt(t);
            for (
              Dt(n) && (n = n.host);
    ...
    var o =
        'clippingParents' === e
          ? (function (t) {
              var e = pe(Yt(t)),
                n =
                  ['absolute', 'fixed'].indexOf(Rt(t).position) >= 0 && St(t)
                    ? Kt(t)
                    : t;
              return jt(n)
                ? e.filter(function (t) {
                    return jt(t) && Wt(t, n) && 'body' !== Tt(t);
                  })
                : [];
            })(t)
          : [].concat(e),
  ...
  class qe extends H {
    ...
    _checkContent(t) {
      for (const [e, n] of Object.entries(t))
        super._typeCheckConfig({ selector: e, entry: n }, Re);
    }
    _setContent(t, e, n) {
      const i = R.findOne(n, t);
      i &&
  ...
  const sn = document.getElementById('toc-bar'),
    ...
    un = document.getElementById('toc-popup-close'),
    fn = 'overflow-hidden',
    dn = 'closing';
  class pn {
    static initBar() {
      (new IntersectionObserver(
        (t) => {
          t.forEach((t) => {
            sn.classList.toggle('invisible', t.isIntersecting);
          });
        },
        { rootMargin: '-'.concat(k(pn, this, mn)._, 'px 0px 0px 0px') },
      ).observe(an),
        (hn._ = k(pn, this, !1)));
    }
    ...
    static refresh() {
      (k(pn, this, hn)._ && this.initComponents(),
    ...
    static lockScroll(t) {
      (document.documentElement.classList.toggle(fn, t),
        document.body.classList.toggle(fn, t));
    }
  ...
  P(pn, 'options', {
    ...
    scrollSmooth: !1,
    collapseDepth: 4,
    headingsOffset: k((rn = pn), rn, mn)._,
  });
  (P(
    class {
      static refresh() {
  ...
  const gn = document.getElementById('mode-toggle');
  const vn = document.getElementById('sidebar'),
    bn = document.getElementById('sidebar-trigger'),
    yn = document.getElementById('mask');
  class _n {
    static toggle() {
      ((wn._ = k(_n, this, !k(_n, this, wn)._)),
        document.body.toggleAttribute('sidebar-display', k(_n, this, wn)._),
        vn.classList.toggle('z-2', k(_n, this, wn)._),
        yn.classList.toggle('d-none', !k(_n, this, wn)._));
    }
  }
  var wn = { _: !1 };
  const En = document.getElementById('sidebar-trigger'),
    ...
    Tn = document.getElementById('search'),
    Ln = document.getElementById('search-result-wrapper'),
    jn = document.getElementById('search-results'),
    Sn = document.getElementById('search-input'),
  ...
  class Bn {
    ...
    static off() {
      (xn.classList.remove(kn),
        ...
        En.classList.remove(Pn),
        Cn.classList.remove(Pn),
        On.classList.remove(Pn));
    }
  }
  class Fn {
    static on() {
      this.resultVisible ||
        (Ln.classList.remove(Pn),
        An.forEach((t) => {
          t.classList.add(Pn);
        }),
    ...
    static off() {
      this.resultVisible &&
        ((jn.innerHTML = ''),
        Dn.classList.contains(Pn) && Dn.classList.remove(Pn),
        Ln.classList.add(Pn),
        An.forEach((t) => {
  ...
  function In() {
    return xn.classList.contains(kn);
  }
  (P(Fn, 'resultVisible', !1),
    (bn.onclick = yn.onclick = () => _n.toggle()),
    On.addEventListener('click', () => {
      (Bn.on(), Fn.on(), Sn.focus());
    }),
    ...
    Sn.addEventListener('focusout', () => {
      Tn.classList.remove(Mn);
    }),
    Sn.addEventListener('input', () => {
      '' === Sn.value
        ? In()
          ? Dn.classList.remove(Pn)
          : Fn.off()
        : (Fn.on(), In() && Dn.classList.add(Pn));
    }),
