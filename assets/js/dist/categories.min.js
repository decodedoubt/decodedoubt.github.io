...
!(function () {
  ...
  const n = 'transitionend',
    ...
    h = function (e, t) {
      ...
      const r = (i) => {
        let { target: s } = i;
        s === t && ((o = !0), t.removeEventListener(n, r), p(e));
      };
  ...
  function E(e, t) {
    return (t && ''.concat(t, '::').concat(y++)) || e.uidEvent || y++;
  }
  function O(e) {
    const t = E(e);
  ...
  function T(e, t, n, i) {
    ...
    for (const [r, s] of Object.entries(o))
      r.includes(i) && L(e, t, n, s.callable, s.delegationSelector);
  }
  function S(e) {
    return ((e = e.replace(m, '')), _[e] || e);
  }
  const j = {
    on(e, t, n, i) {
      C(e, t, n, i, !1);
    ...
    off(e, t, n, i) {
      ...
      const [o, r, s] = A(t, n, i),
        ...
        f = t.startsWith('.');
      if (void 0 === r) {
        if (f) for (const n of Object.keys(c)) T(e, c, n, t.slice(1));
        for (const [n, i] of Object.entries(l)) {
          const o = n.replace(v, '');
          (a && !t.includes(o)) || L(e, c, s, i.callable, i.delegationSelector);
        }
      } else {
    ...
    trigger(e, t, n) {
      ...
      const c = k(new Event(t, { bubbles: r, cancelable: !0 }), n);
      return (
        a && c.preventDefault(),
        s && e.dispatchEvent(c),
  ...
  const F = {
    ...
    getDataAttribute: (e, t) => B(e.getAttribute('data-bs-'.concat(I(t)))),
  };
  class H {
    static get Default() {
      return {};
    ...
    _mergeConfigObj(e, t) {
      const n = r(t) ? F.getDataAttribute(t, 'config') : {};
      return M(
        M(
          M(M({}, this.constructor.Default), 'object' == typeof n ? n : {}),
          r(t) ? F.getDataAttributes(t) : {},
        ),
        'object' == typeof e ? e : {},
      );
    }
  ...
  class ne extends z {
    ...
    _initializeChildren() {
      ...
      const e = this._getFirstLevelChildren(Z);
      for (const t of e) {
    ...
    _getFirstLevelChildren(e) {
      const t = q.find(J, this._config.parent);
    ...
    static jQueryInterface(e) {
      ...
      return (
        ...
        this.each(function () {
          const n = ne.getOrCreateInstance(this, t);
          if ('string' == typeof e) {
            if (void 0 === n[e])
  ...
  (j.on(document, Q, Z, function (e) {
    ...
    d(ne));
  const ie = document.getElementsByClassName('collapse');
  var oe = 'top',
    re = 'bottom',
    se = 'right',
    ae = 'left',
    ...
    he = 'popper',
    ge = 'reference',
    me = le.reduce(function (e, t) {
      return e.concat([t + '-' + fe, t + '-' + ue]);
    }, []),
    ve = [].concat(le, [ce]).reduce(function (e, t) {
      return e.concat([t, t + '-' + fe, t + '-' + ue]);
    }, []),
    be = 'beforeRead',
    ye = 'read',
    _e = 'afterRead',
  ...
  function Pe(e) {
    return (
      ...
      (e instanceof Se(e).ShadowRoot || e instanceof ShadowRoot)
    );
  }
  var De = {
    name: 'applyStyles',
  ...
  function ze(e, t, n) {
    ...
    t &&
      ke(e) &&
      ((o = (e.offsetWidth > 0 && Ie(i.width) / e.offsetWidth) || 1),
      (r = (e.offsetHeight > 0 && Ie(i.height) / e.offsetHeight) || 1));
    var s = (je(e) ? Se(e) : window).visualViewport,
      a = !He() && n,
  ...
  function Ue(e) {
    return 'html' === Te(e)
      ? e
      : e.assignedSlot || e.parentNode || (Pe(e) ? e.host : null) || Ye(e);
  }
  function Ke(e) {
    return ke(e) && 'fixed' !== Re(e).position ? e.offsetParent : null;
  }
  function Qe(e) {
    for (var t = Se(e), n = Ke(e); n && Ve(n) && 'static' === Re(n).position; )
      n = Ke(n);
    return n &&
      ('html' === Te(n) || ('body' === Te(n) && 'static' === Re(n).position))
      ? t
      : n ||
          (function (e) {
            var t = /firefox/i.test(Fe());
            if (/Trident/i.test(Fe()) && ke(e) && 'fixed' === Re(e).position)
              return null;
            var n = Ue(e);
            for (
              Pe(n) && (n = n.host);
              ke(n) && ['html', 'body'].indexOf(Te(n)) < 0;
            ) {
              var i = Re(n);
              if (
                'none' !== i.transform ||
  ...
  var Ze = {
    ...
    fn: function (e) {
      var t,
        ...
        a = Ne(n.placement),
        c = Xe(a),
        l = [ae, se].indexOf(a) >= 0 ? 'height' : 'width';
      if (r && s) {
        var f = (function (e, t) {
            return Ge(
              'number' !=
  ...
  function nt(e) {
    var t,
      ...
      h = s.y,
      g = void 0 === h ? 0 : h,
      m = 'function' == typeof f ? f({ x: p, y: g }) : { x: p, y: g };
    ((p = m.x), (g = m.y));
    ...
    var A,
      C = Object.assign({ position: a }, l && tt),
      L =
        !0 === f
          ? (function (e, t) {
              var n = e.x,
              ...
              return { x: Ie(n * o) / o || 0, y: Ie(i * o) / o || 0 };
            })({ x: p, y: g }, Se(n))
          : { x: p, y: g };
    return (
      (p = L.x),
  ...
  function ut(e) {
    return ze(Ye(e)).left + ft(e).scrollLeft;
  }
  function dt(e) {
    var t = Re(e),
      n = t.overflow,
        ...
        : gt(
            (function (e) {
              var t,
                ...
                c = -i.scrollTop;
              return (
                'rtl' === Re(o || n).direction &&
                  (a += Me(n.clientWidth, o ? o.clientWidth : 0) - r),
    ...
    var o =
        'clippingParents' === t
          ? (function (e) {
              var t = ht(Ue(e)),
                n =
                  ['absolute', 'fixed'].indexOf(Re(e).position) >= 0 && ke(e)
                    ? Qe(e)
                    : e;
              return je(n)
                ? t.filter(function (e) {
                    return je(e) && qe(e, n) && 'body' !== Te(e);
                  })
                : [];
            })(e)
          : [].concat(t),
      ...
      a = r.reduce(
        function (t, n) {
          var o = mt(e, n, i);
          return (
            (t.top = Me(o.top, t.top)),
            (t.right = Be(o.right, t.right)),
            (t.bottom = Be(o.bottom, t.bottom)),
            (t.left = Me(o.left, t.left)),
            t
          );
        },
        mt(e, s, i),
  ...
  function yt(e, t) {
    ...
    var n = t,
      ...
      g = n.padding,
      m = void 0 === g ? 0 : g,
      v = Ge('number' != typeof m ? m : Je(m, le)),
      b = d === he ? ge : he,
      y = e.rects.popper,
      _ = e.elements[h ? b : d],
      w = vt(je(_) ? _ : _.contextElement || Ye(e.elements.popper), c, f, s),
      E = ze(e.elements.reference),
      O = bt({ reference: E, element: y, placement: o }),
      x = gt(Object.assign({}, y, O)),
      A = d === he ? x : E,
      C = {
    ...
    if (d === he && L) {
      ...
      Object.keys(C).forEach(function (e) {
        var t = [se, re].indexOf(e) >= 0 ? 1 : -1,
          n = [oe, re].indexOf(e) >= 0 ? 'y' : 'x';
        C[e] += T[n] * t;
      });
    }
    return C;
  ...
  function Ot(e) {
    return [oe, se, re, ae].some(function (t) {
      return e[t] >= 0;
    });
  }
  var xt = {
  ...
  var At = {
    ...
    fn: function (e) {
      var t = e.state,
        ...
        o = n.offset,
        r = void 0 === o ? [0, 0] : o,
        s = ve.reduce(function (e, n) {
          return (
            (e[n] = (function (e, t, n) {
              var i = Ne(e),
                o = [ae, oe].indexOf(i) >= 0 ? -1 : 1,
                r =
                  'function' == typeof n
              ...
              return (
                (s = s || 0),
                (a = (a || 0) * o),
                [ae, se].indexOf(i) >= 0 ? { x: a, y: s } : { x: s, y: a }
              );
            })(n, t.rects, r)),
            e
          );
  ...
  var Lt = {
    ...
    fn: function (e) {
      var t = e.state,
        ...
        h = n.tetherOffset,
        g = void 0 === h ? 0 : h,
        m = yt(t, { boundary: c, rootBoundary: l, padding: u, altBoundary: f }),
        v = Ne(t.placement),
        b = et(t.placement),
        y = !b,
        _ = Xe(v),
      ...
      if (E) {
        if (r) {
          var S,
            ...
            K = t.elements.arrow && Qe(t.elements.arrow),
            Q = K ? ('y' === _ ? K.clientTop || 0 : K.clientLeft || 0) : 0,
            X = null != (S = null == L ? void 0 : L[_]) ? S : 0,
            $ = D + U - X,
            G = $e(p ? Be(N, D + Y - X - Q) : N, D, p ? Me(M, $) : M);
          ((E[_] = G), (T[_] = G - D));
        }
        if (a) {
          var J,
            ...
            ie = te + m[Z],
            ce = te - m[ee],
            le = -1 !== [oe, ae].indexOf(v),
            ue = null != (J = null == L ? void 0 : L[w]) ? J : 0,
            de = le ? ie : te - O[ne] - x[ne] - ue + C.altAxis,
            pe = le ? te + O[ne] + x[ne] - ue - C.altAxis : ce,
            he =
              p && le
                ? (function (e, t, n) {
                    var i = $e(e, t, n);
        ...
        (('body' !== Te(t) || dt(a)) &&
          (l =
            (i = t) !== Se(i) && ke(i)
              ...
              : ft(i)),
        ke(t)
          ? (((f = ze(t, !0)).x += t.clientLeft), (f.y += t.clientTop))
          : a && (f.x = ut(a))),
      {
        ...
        f = {
          ...
          forceUpdate: function () {
            if (!l) {
              ...
              if (kt(t, n)) {
                ((a.rects = {
                  reference: Tt(t, Qe(n), 'fixed' === a.options.strategy),
                  popper: We(n),
                }),
                  (a.reset = !1),
                ...
                for (var i = 0; i < a.orderedModifiers.length; i++)
                  if (!0 !== a.reset) {
                    ...
                    'function' == typeof r &&
                      (a =
                        r({ state: a, options: c, name: u, instance: f }) || a);
                  } else ((a.reset = !1), (i = -1));
              }
            }
          },
  ...
  var Dt = Pt(),
    Nt = Pt({ defaultModifiers: [rt, Ct, it, De] }),
    Mt = Pt({ defaultModifiers: [rt, Ct, it, De, At, wt, Lt, Ze, xt] }),
    Bt = Object.freeze({
      __proto__: null,
      afterMain: Oe,
      afterRead: _e,
  ...
  const It = {
    ...
    zt = (e, t) => {
      ...
      return t.includes(n)
        ? !Ft.has(n) || Boolean(Ht.test(e.nodeValue))
  ...
  class Vt extends H {
    ...
    changeContent(e) {
      return (
        ...
        (this._config.content = M(M({}, this._config.content), e)),
        this
      );
    }
    toHtml() {
    ...
    _checkContent(e) {
      for (const [t, n] of Object.entries(e))
        super._typeCheckConfig({ selector: t, entry: n }, Rt);
    }
    _setContent(e, t, n) {
        ...
        ? (function (e, t, n) {
            ...
            for (const e of o) {
              ...
              const i = [].concat(...e.attributes),
                o = [].concat(t['*'] || [], t[n] || []);
              for (const t of i) zt(t, o) || e.removeAttribute(t.nodeName);
            }
  ...
  const Yt = new Set(['sanitize', 'allowList', 'sanitizeFn']),
    Ut = 'fade',
    Kt = 'show',
    Qt = '.tooltip-inner',
    Xt = '.'.concat('modal'),
  ...
  class on extends z {
    ...
    dispose() {
      (clearTimeout(this._timeout),
        j.off(this._element.closest(Xt), $t, this._hideModalHandler),
    ...
    _createTipElement(e) {
      ...
      return (
        t.setAttribute('id', n),
        this._isAnimated() && t.classList.add(Ut),
        t
      );
    }
    setContent(e) {
    ...
    _isAnimated() {
      return (
        this._config.animation || (this.tip && this.tip.classList.contains(Ut))
      );
    }
    _isShown() {
    ...
    _createPopper(e) {
      const t = p(this._config.placement, [this, e, this._element]),
        n = en[t.toUpperCase()];
      return Mt(this._element, e, this._getPopperConfig(n));
    }
    _getOffset() {
    ...
    _resolvePossibleFunction(e) {
      return p(e, [this._element, this._element]);
    }
    _getPopperConfig(e) {
      const t = {
        placement: e,
      ...
      return M(M({}, t), p(this._config.popperConfig, [void 0, t]));
    }
    _setListeners() {
        ...
        if ('click' === t)
          j.on(
            ...
            (e) => {
              ...
              ((t._activeTrigger[Zt] = !(t._isShown() && t._activeTrigger[Zt])),
                t.toggle());
            },
          );
        else if ('manual' !== t) {
          ...
          (j.on(this._element, e, this._config.selector, (e) => {
            const t = this._initializeOnDelegatedTarget(e);
            ((t._activeTrigger['focusin' === e.type ? Jt : Gt] = !0),
              t._enter());
          }),
            j.on(this._element, n, this._config.selector, (e) => {
              const t = this._initializeOnDelegatedTarget(e);
              ((t._activeTrigger['focusout' === e.type ? Jt : Gt] =
      ...
      ((this._hideModalHandler = () => {
        ...
        j.on(this._element.closest(Xt), $t, this._hideModalHandler));
    }
    _fixTitle() {
    ...
    _getConfig(e) {
      ...
      for (const e of Object.keys(t)) Yt.has(e) && delete t[e];
      return (
        (e = M(M({}, t), 'object' == typeof e && e ? e : {})),
        (e = this._mergeConfigObj(e)),
        (e = this._configAfterMerge(e)),
        this._typeCheckConfig(e),
        e
  ...
  var rn;
  d(on);
  const sn = document.getElementById('toc-bar'),
  ...
  class pn {
    static initBar() {
      (new IntersectionObserver(
        (e) => {
          e.forEach((e) => {
            sn.classList.toggle('invisible', e.isIntersecting);
          });
        },
        { rootMargin: '-'.concat(P(pn, this, gn)._, 'px 0px 0px 0px') },
      ).observe(an),
        (hn._ = P(pn, this, !1)));
    }
    ...
    static refresh() {
      (P(pn, this, hn)._ && this.initComponents(),
    ...
    static initComponents() {
      (this.initBar(),
        ...
        (ln.onclick = (e) => this.clickBackdrop(e)),
  ...
  D(pn, 'options', {
    ...
    scrollSmooth: !1,
    collapseDepth: 4,
    headingsOffset: P((rn = pn), rn, gn)._,
  });
  (D(
    class {
      static refresh() {
  ...
  const mn = document.getElementById('mode-toggle');
  const vn = document.getElementById('sidebar'),
    bn = document.getElementById('sidebar-trigger'),
    yn = document.getElementById('mask');
  class _n {
    static toggle() {
      ((wn._ = P(_n, this, !P(_n, this, wn)._)),
        document.body.toggleAttribute('sidebar-display', P(_n, this, wn)._),
        vn.classList.toggle('z-2', P(_n, this, wn)._),
        yn.classList.toggle('d-none', !P(_n, this, wn)._));
    }
  }
  var wn = { _: !1 };
  const En = document.getElementById('sidebar-trigger'),
    On = document.getElementById('search-trigger'),
    xn = document.getElementById('search-cancel'),
    An = document.querySelectorAll('#main-wrapper>.container>.row'),
    Cn = document.getElementById('topbar-title'),
    Ln = document.getElementById('search'),
    Tn = document.getElementById('search-result-wrapper'),
    Sn = document.getElementById('search-results'),
    jn = document.getElementById('search-input'),
    kn = document.getElementById('search-hints'),
    Pn = 'd-block',
    Dn = 'd-none',
    Nn = 'input-focus',
    Mn = 'd-flex';
  class Bn {
    ...
    static off() {
      (xn.classList.remove(Pn),
        Ln.classList.remove(Mn),
        En.classList.remove(Dn),
        Cn.classList.remove(Dn),
        On.classList.remove(Dn));
    }
  }
  class In {
    static on() {
      this.resultVisible ||
        (Tn.classList.remove(Dn),
        An.forEach((e) => {
          e.classList.add(Dn);
        }),
    ...
    static off() {
      this.resultVisible &&
        ((Sn.innerHTML = ''),
        kn.classList.contains(Dn) && kn.classList.remove(Dn),
        Tn.classList.add(Dn),
        An.forEach((e) => {
  ...
  function Fn() {
    return xn.classList.contains(Pn);
  }
  (D(In, 'resultVisible', !1),
    mn &&
    ...
    (bn.onclick = yn.onclick = () => _n.toggle()),
    On.addEventListener('click', () => {
      (Bn.on(), In.on(), jn.focus());
    }),
    ...
    jn.addEventListener('input', () => {
      '' === jn.value
        ? Fn()
          ? kn.classList.remove(Dn)
          : In.off()
        : (In.on(), Fn() && kn.classList.add(Dn));
    }),
    [...ie].forEach((e) => {
