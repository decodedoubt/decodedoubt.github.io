...
!(function () {
  ...
  const I = {
    setDataAttribute(t, e, n) {
      t.setAttribute('data-bs-'.concat(F(e)), n);
    },
    ...
    getDataAttribute: (t, e) => B(t.getAttribute('data-bs-'.concat(F(e)))),
  };
  class H {
    static get Default() {
      return {};
    ...
    _mergeConfigObj(t, e) {
      const n = r(e) ? I.getDataAttribute(e, 'config') : {};
      return N(
        N(
          N(N({}, this.constructor.Default), 'object' == typeof n ? n : {}),
          r(e) ? I.getDataAttributes(e) : {},
        ),
        'object' == typeof t ? t : {},
      );
    }
  ...
  class nt extends z {
    ...
    show() {
      ...
      if (
        ...
        return;
      if (S.trigger(this._element, V).defaultPrevented) return;
    ...
    hide() {
      if (this._isTransitioning || !this._isShown()) return;
      if (S.trigger(this._element, U).defaultPrevented) return;
  ...
  function Ht(t, e, n) {
    ...
    var s = (jt(t) ? Lt(t) : window).visualViewport,
      a = !It() && n,
  ...
  function Vt(t) {
    return ((jt(t) ? t.ownerDocument : t.document) || window.document)
      .documentElement;
  }
  function Yt(t) {
    return 'html' === Tt(t)
  ...
  function Ut(t) {
    return St(t) && 'fixed' !== Wt(t).position ? t.offsetParent : null;
  }
  function Kt(t) {
    ...
    return n &&
      ...
      : n ||
          (function (t) {
            var e = /firefox/i.test(Ft());
            if (/Trident/i.test(Ft()) && St(t) && 'fixed' === Wt(t).position)
              return null;
            var n = Yt(t);
            for (
              Dt(n) && (n = n.host);
              St(n) && ['html', 'body'].indexOf(Tt(n)) < 0;
            ) {
              var i = Wt(n);
              if (
                'none' !== i.transform ||
            ...
            (function (t) {
              ...
              return (
                'rtl' === Wt(o || n).direction &&
                  (a += Mt(n.clientWidth, o ? o.clientWidth : 0) - r),
    ...
    var o =
        'clippingParents' === e
          ? (function (t) {
              var e = pe(Yt(t)),
                n =
                  ['absolute', 'fixed'].indexOf(Wt(t).position) >= 0 && St(t)
                    ? Kt(t)
                    : t;
              return jt(n)
                ? e.filter(function (t) {
                    return jt(t) && qt(t, n) && 'body' !== Tt(t);
                  })
                : [];
            })(t)
          : [].concat(e),
  ...
  function be(t, e) {
    ...
    var n = e,
      ...
      m = n.padding,
      g = void 0 === m ? 0 : m,
      v = $t('number' != typeof g ? g : Gt(g, ct)),
      b = d === pt ? ht : pt,
      y = t.rects.popper,
      _ = t.elements[h ? b : d],
      w = ge(jt(_) ? _ : _.contextElement || Vt(t.elements.popper), c, u, s),
      E = Ht(t.elements.reference),
      O = ve({ reference: E, element: y, placement: o }),
      x = he(Object.assign({}, y, O)),
      A = d === pt ? x : E,
      C = {
      ...
      if (E) {
        if (r) {
          var j,
            ...
            $ = P + U - X,
            G = Xt(p ? Nt(M, P + Y - X - Q) : M, P, p ? Mt(N, $) : N);
          ((E[_] = G), (L[_] = G - P));
        }
        if (a) {
          var J,
            ...
            at = et + g[Z],
            ct = et - g[tt],
            ut = -1 !== [it, st].indexOf(v),
            ft = null != (J = null == T ? void 0 : T[w]) ? J : 0,
            dt = ut ? at : et - O[nt] - x[nt] - ft + C.altAxis,
            pt = ut ? et + O[nt] + x[nt] - ft - C.altAxis : ct,
            ht =
              p && ut
                ? (function (t, e, n) {
                    var i = Xt(t, e, n);
  ...
  var ke = De(),
    Pe = De({ defaultModifiers: [oe, Ae, ne, kt] }),
    Me = De({ defaultModifiers: [oe, Ae, ne, kt, xe, _e, Ce, Jt, Oe] }),
    Ne = Object.freeze({
      __proto__: null,
      afterMain: Et,
      afterRead: yt,
  ...
  const Be = {
    ...
    He = (t, e) => {
      ...
      return e.includes(n)
        ? !Fe.has(n) || Boolean(Ie.test(t.nodeValue))
  ...
  class nn extends z {
    ...
    dispose() {
      (clearTimeout(this._timeout),
        S.off(this._element.closest(Qe), Xe, this._hideModalHandler),
    ...
    _getPopperConfig(t) {
      ...
      return N(N({}, e), p(this._config.popperConfig, [void 0, e]));
    }
    _setListeners() {
      ...
      for (const e of t)
        if ('click' === e)
          ...
          (S.on(this._element, t, this._config.selector, (t) => {
            const e = this._initializeOnDelegatedTarget(t);
            ((e._activeTrigger['focusin' === t.type ? Ge : $e] = !0),
              e._enter());
          }),
            S.on(this._element, n, this._config.selector, (t) => {
              const e = this._initializeOnDelegatedTarget(t);
              ((e._activeTrigger['focusout' === t.type ? Ge : $e] =
      ...
      ((this._hideModalHandler = () => {
        ...
        S.on(this._element.closest(Qe), Xe, this._hideModalHandler));
    }
    _fixTitle() {
  ...
  function ln() {
    this.complete &&
      (this.hasAttribute(rn) ? cn.call(this, an) : cn.call(this, sn));
  }
  function un() {
    const t = this.getAttribute(on);
    (this.setAttribute('src', encodeURI(t)), this.removeAttribute(on));
  }
  class fn {
  ...
  var dn;
  const pn = document.getElementById('toc-bar'),
    hn = document.getElementById('toc-solo-trigger'),
    mn = document.getElementsByClassName('toc-trigger'),
    gn = document.getElementById('toc-popup'),
    vn = document.getElementById('toc-popup-close'),
    bn = 'overflow-hidden',
    yn = 'closing';
  class _n {
    static initBar() {
      (new IntersectionObserver(
        (t) => {
          t.forEach((t) => {
            pn.classList.toggle('invisible', t.isIntersecting);
          });
        },
        { rootMargin: '-'.concat(k(_n, this, En)._, 'px 0px 0px 0px') },
      ).observe(hn),
        (wn._ = k(_n, this, !1)));
    }
    ...
    static refresh() {
      (k(_n, this, wn)._ && this.initComponents(),
    ...
    static showPopup() {
      (this.lockScroll(!0), gn.showModal());
      gn.querySelector('li.is-active-li').scrollIntoView({ block: 'center' });
    }
    static hidePopup() {
      (gn.toggleAttribute(yn),
        gn.addEventListener(
          'animationend',
          () => {
            (gn.toggleAttribute(yn), gn.close());
          },
          { once: !0 },
        ),
        this.lockScroll(!1));
    ...
    static lockScroll(t) {
      (document.documentElement.classList.toggle(bn, t),
        document.body.classList.toggle(bn, t));
    }
    static clickBackdrop(t) {
      if (gn.hasAttribute(yn)) return;
    ...
    static initComponents() {
      (this.initBar(),
        ...
        (gn.onclick = (t) => this.clickBackdrop(t)),
        (vn.onclick = () => this.hidePopup()),
        (gn.oncancel = (t) => {
  ...
  P(_n, 'options', {
    ...
    scrollSmooth: !1,
    collapseDepth: 4,
    headingsOffset: k((dn = _n), dn, En)._,
  });
  (P(
    class {
      static refresh() {
  ...
  const On = document.getElementById('mode-toggle');
  const xn = document.getElementById('sidebar'),
    An = document.getElementById('sidebar-trigger'),
    Cn = document.getElementById('mask');
  class Tn {
    static toggle() {
      ((Ln._ = k(Tn, this, !k(Tn, this, Ln)._)),
        document.body.toggleAttribute('sidebar-display', k(Tn, this, Ln)._),
        xn.classList.toggle('z-2', k(Tn, this, Ln)._),
        Cn.classList.toggle('d-none', !k(Tn, this, Ln)._));
    }
  }
  var Ln = { _: !1 };
  const jn = document.getElementById('sidebar-trigger'),
    Sn = document.getElementById('search-trigger'),
    Dn = document.getElementById('search-cancel'),
    kn = document.querySelectorAll('#main-wrapper>.container>.row'),
    Pn = document.getElementById('topbar-title'),
    Mn = document.getElementById('search'),
    Nn = document.getElementById('search-result-wrapper'),
    Bn = document.getElementById('search-results'),
    Fn = document.getElementById('search-input'),
    In = document.getElementById('search-hints'),
    Hn = 'd-block',
    zn = 'd-none',
    qn = 'input-focus',
    Wn = 'd-flex';
  class Rn {
    ...
    static off() {
      (Dn.classList.remove(Hn),
        Mn.classList.remove(Wn),
        jn.classList.remove(zn),
        Pn.classList.remove(zn),
        Sn.classList.remove(zn));
    }
  }
  class Vn {
    static on() {
      this.resultVisible ||
        (Nn.classList.remove(zn),
        kn.forEach((t) => {
          t.classList.add(zn);
        }),
    ...
    static off() {
      this.resultVisible &&
        ((Bn.innerHTML = ''),
        In.classList.contains(zn) && In.classList.remove(zn),
        Nn.classList.add(zn),
        kn.forEach((t) => {
  ...
  function Yn() {
    return Dn.classList.contains(Hn);
  }
  (P(Vn, 'resultVisible', !1),
    (function () {
      const t = document.querySelectorAll('article img');
      if (0 === t.length) return;
      (t.forEach((t) => {
        t.addEventListener('load', ln);
      }),
        document
          .querySelectorAll('article img[loading="lazy"]')
          .forEach((t) => {
            t.complete && cn.call(t, sn);
          }));
      const e = document.querySelectorAll(
        'article img['.concat(rn, '="true"]'),
      );
      e.length &&
        e.forEach((t) => {
          un.call(t);
    ...
    dayjs.locale(fn.locale),
    dayjs.extend(window.dayjs_plugin_localizedFormat),
    document
      .querySelectorAll('['.concat(fn.attrTimestamp, ']'))
      .forEach((t) => {
        const e = dayjs.unix(fn.getTimestamp(t)),
          n = e.format(fn.getDateFormat(t));
        if (
          ((t.textContent = n),
          t.removeAttribute(fn.attrTimestamp),
          t.removeAttribute(fn.attrDateFormat),
    ...
    (An.onclick = Cn.onclick = () => Tn.toggle()),
    Sn.addEventListener('click', () => {
      (Rn.on(), Vn.on(), Fn.focus());
    }),
    Dn.addEventListener('click', () => {
      (Rn.off(), Vn.off());
    }),
    Fn.addEventListener('focus', () => {
      Mn.classList.add(qn);
    }),
    Fn.addEventListener('focusout', () => {
      Mn.classList.remove(qn);
    }),
    Fn.addEventListener('input', () => {
      '' === Fn.value
        ? Yn()
          ? In.classList.remove(zn)
          : Vn.off()
        : (Vn.on(), Yn() && In.classList.add(zn));
    }),
    On &&
